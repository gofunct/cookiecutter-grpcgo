...
import (
	...
	user_pb "github.com/gofunct/user/gen/user"
	user_endpoints "github.com/gofunct/user/gen/user/endpoints"
	user_svc "github.com/gofunct/user/services/user"
	user_grpctransport "github.com/gofunct/user/gen/user/transports/grpc"
