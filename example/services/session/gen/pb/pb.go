...
func (*LoginRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_0afef3315ae0d1ca, []int{0}
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_0afef3315ae0d1ca, []int{1}
}
...
func init() {
	proto.RegisterFile("services/session/session.proto", fileDescriptor_session_0afef3315ae0d1ca)
}

var fileDescriptor_session_0afef3315ae0d1ca = []byte{
